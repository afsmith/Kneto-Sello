...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MessageProfile.header_message_id'
        db.add_column('messages_custom_messageprofile', 'header_message_id', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=100), keep_default=False)

        # Adding field 'MessageProfile.header_in_reply_to'
        db.add_column('messages_custom_messageprofile', 'header_in_reply_to', self.gf('django.db.models.fields.CharField')(default='', max_length=100, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MessageProfile.header_message_id'
        db.delete_column('messages_custom_messageprofile', 'header_message_id')

        # Deleting field 'MessageProfile.header_in_reply_to'
        db.delete_column('messages_custom_messageprofile', 'header_in_reply_to')
    ...
    models = {
        ...
        'messages_custom.messageprofile': {
            ...
            'header_in_reply_to': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'db_index': 'True'}),
            'header_message_id': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
