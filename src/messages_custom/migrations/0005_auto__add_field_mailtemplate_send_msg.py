...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MailTemplate.send_msg'
        db.add_column('messages_custom_mailtemplate', 'send_msg', self.gf('django.db.models.fields.CharField')(default='D', max_length=2), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MailTemplate.send_msg'
        db.delete_column('messages_custom_mailtemplate', 'send_msg')
