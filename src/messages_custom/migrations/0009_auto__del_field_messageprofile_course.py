...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MessageProfile.course'
        db.delete_column('messages_custom_messageprofile', 'course_id')

        # Adding M2M table for field courses on 'MessageProfile'
        db.create_table('messages_custom_messageprofile_courses', (
        ...
        db.create_unique('messages_custom_messageprofile_courses', ['messageprofile_id', 'course_id'])


    def backwards(self, orm):
        
        # Adding field 'MessageProfile.course'
        db.add_column('messages_custom_messageprofile', 'course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Course'], null=True), keep_default=False)

        # Removing M2M table for field courses on 'MessageProfile'
        db.delete_table('messages_custom_messageprofile_courses')
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'tOhcRHErWkjfPyyYFCvPc1HBxU3Yvg'", 'max_length': '30'}),
