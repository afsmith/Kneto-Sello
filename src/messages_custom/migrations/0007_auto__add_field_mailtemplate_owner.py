...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MailTemplate.owner'
        db.add_column('messages_custom_mailtemplate', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MailTemplate.owner'
        db.delete_column('messages_custom_mailtemplate', 'owner_id')
    ...
    models = {
        ...
        'content.course': {
            ...
            'completion_msg': ('django.db.models.fields.TextField', [], {'default': "'Lesson finished'", 'blank': 'True'}),
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'z7shi1i87TNVOpXFOQjozIfcN8JN5Y'", 'max_length': '30'}),
