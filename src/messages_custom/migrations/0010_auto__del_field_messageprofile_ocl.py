...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MessageProfile.ocl'
        db.delete_column('messages_custom_messageprofile', 'ocl_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'MessageProfile.ocl'
        db.add_column('messages_custom_messageprofile', 'ocl', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['management.OneClickLinkToken'], null=True), keep_default=False)
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'3nINQoXnJvwmE1ZlecaRlLVPJRqUay'", 'max_length': '30'}),
        ...
        'messages_custom.messageprofile': {
            ...
            'ocls': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['management.OneClickLinkToken']", 'null': 'True', 'symmetrical': 'False'})
        }
    }
