...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.is_deleted'
        db.add_column('reports_report', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.is_deleted'
        db.delete_column('reports_report', 'is_deleted')
