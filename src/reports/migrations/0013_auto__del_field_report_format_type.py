...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Report.format_type'
        db.delete_column('reports_report', 'format_type')


    def backwards(self, orm):
        
        # Adding field 'Report.format_type'
        db.add_column('reports_report', 'format_type', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
