...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.show_all'
        db.add_column('reports_report', 'show_all', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.show_all'
        db.delete_column('reports_report', 'show_all')
