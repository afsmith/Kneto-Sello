...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.admin_required'
        db.add_column('reports_report', 'admin_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Report.admin_shown'
        db.add_column('reports_report', 'admin_shown', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.admin_required'
        db.delete_column('reports_report', 'admin_required')

        # Deleting field 'Report.admin_shown'
        db.delete_column('reports_report', 'admin_shown')
