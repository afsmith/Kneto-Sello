...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportResult.csv_file_path'
        db.add_column('reports_reportresult', 'csv_file_path', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReportResult.csv_file_path'
        db.delete_column('reports_reportresult', 'csv_file_path')
