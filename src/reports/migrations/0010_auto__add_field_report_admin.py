...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.admin'
        db.add_column('reports_report', 'admin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.admin'
        db.delete_column('reports_report', 'admin_id')
