...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reports_report', (
            ...
            ('template_path', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('executed_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('schedule_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('schedule_day', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('reports', ['Report'])

        # Adding model 'ReportResult'
        db.create_table('reports_reportresult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Report'])),
            ('file_path', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('reports', ['ReportResult'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ReportResult'
        db.delete_table('reports_reportresult')
    ...
    models = {
        ...
        'reports.report': {
            ...
            'executed_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
