...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.schedule_hour'
        db.add_column('reports_report', 'schedule_hour', self.gf('django.db.models.fields.CharField')(default='00:00', max_length=5, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.schedule_hour'
        db.delete_column('reports_report', 'schedule_hour')
