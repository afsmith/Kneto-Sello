...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.user_required'
        db.add_column('reports_report', 'user_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Report.group_required'
        db.add_column('reports_report', 'group_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Report.course_required'
        db.add_column('reports_report', 'course_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.user_required'
        db.delete_column('reports_report', 'user_required')

        # Deleting field 'Report.group_required'
        db.delete_column('reports_report', 'group_required')

        # Deleting field 'Report.course_required'
        db.delete_column('reports_report', 'course_required')
