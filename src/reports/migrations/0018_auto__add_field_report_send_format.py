...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.send_format'
        db.add_column('reports_report', 'send_format', self.gf('django.db.models.fields.CharField')(default='pdf', max_length=14), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.send_format'
        db.delete_column('reports_report', 'send_format')
    ...
    models = {
        ...
        'reports.report': {
            ...
            'send_format': ('django.db.models.fields.CharField', [], {'max_length': '14'}),
