...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.is_template'
        db.add_column('reports_report', 'is_template', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.is_template'
        db.delete_column('reports_report', 'is_template')
