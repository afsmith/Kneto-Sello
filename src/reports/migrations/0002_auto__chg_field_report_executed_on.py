...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.executed_on'
        db.alter_column('reports_report', 'executed_on', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Report.executed_on'
        db.alter_column('reports_report', 'executed_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 4, 7)))
