...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportResult.html_file_path'
        db.add_column('reports_reportresult', 'html_file_path', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True), keep_default=False)

        # Changing field 'ReportResult.file_path'
        db.alter_column('reports_reportresult', 'file_path', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))


    def backwards(self, orm):
        
        # Deleting field 'ReportResult.html_file_path'
        db.delete_column('reports_reportresult', 'html_file_path')

        # Changing field 'ReportResult.file_path'
        db.alter_column('reports_reportresult', 'file_path', self.gf('django.db.models.fields.CharField')(default=None, max_length=128))
    ...
    models = {
        ...
        'reports.report': {
            ...
            'format_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
