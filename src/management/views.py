...
from content.course_states import ActiveInUse, DeactivatedUsed, Active, ActiveAssign

from content.models import Collection, Course, CourseGroup, File
...
def edit_user(request, id):
    ...
    return direct_to_template(request, 'management/dialogs/edit_user.html', {
        'form': form,
        'edited_user': user,
    })
...
def create_group(request):
    ...
    return direct_to_template(request, 'management/edit_group.html', {
        'form': form,
        })
...
def import_users(request, group_id):
    ...
    return direct_to_template(request, 'management/import_csv.html', ctx)
...
def user_profile(request):
    return direct_to_template(request, 'management/user_profile.html')
...
def login_screen(request):
    ...
    if request.method == 'POST':
        ...
        return login(request, authentication_form=forms.AuthenticationForm)
    else:
