...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupProfile.user_count'
        db.add_column('management_groupprofile', 'user_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupProfile.user_count'
        db.delete_column('management_groupprofile', 'user_count')
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'tc9jkvbDbcxLNccWKFnGx9hRllq5m3'", 'max_length': '30'}),
