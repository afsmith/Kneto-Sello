...
from management.models import GroupProfile, UserProfile
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for group in Group.objects.all():
            (gprofile, created) = GroupProfile.objects.get_or_create(group=group)
            gprofile.user_count = group.user_set.filter(userprofile__role__gt=UserProfile.ROLE_ADMIN).count()
            gprofile.save()


    def backwards(self, orm):
        "Write your backwards methods here."
        for gprofile in GroupProfile.objects.all():
            if not gprofile.self_register_enabled:
                gprofile.delete()
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'xGG65wz0DN8l4xnXVrkMQtUgKLm6ba'", 'max_length': '30'}),
