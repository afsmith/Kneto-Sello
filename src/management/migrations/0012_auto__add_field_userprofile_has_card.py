...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.has_card'
        db.add_column('management_userprofile', 'has_card', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.has_card'
        db.delete_column('management_userprofile', 'has_card')
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'UBoLKh9IeBFqlqPeHQVj1yLT4Xd15c'", 'max_length': '30'}),
