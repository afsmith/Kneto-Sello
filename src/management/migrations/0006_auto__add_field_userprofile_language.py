...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('management_userprofile', 'language', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.language'
        db.delete_column('management_userprofile', 'language')
