...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('management_groupprofile', (
            ('group', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.Group'], unique=True, primary_key=True)),
            ('self_register_enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('management', ['GroupProfile'])


    def backwards(self, orm):
        
        # Deleting model 'GroupProfile'
        db.delete_table('management_groupprofile')
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'8wZvfuW40NfoMjPueeniLPrOplFz53'", 'max_length': '30'}),
