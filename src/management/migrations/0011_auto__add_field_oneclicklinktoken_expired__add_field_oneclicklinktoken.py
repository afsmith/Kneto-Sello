...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('management_oneclicklinktoken', 'expired', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)

        # Adding field 'OneClickLinkToken.expires_on'
        db.add_column('management_oneclicklinktoken', 'expires_on', self.gf('django.db.models.fields.DateField')(null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OneClickLinkToken.expired'
        db.delete_column('management_oneclicklinktoken', 'expired')

        # Deleting field 'OneClickLinkToken.expires_on'
        db.delete_column('management_oneclicklinktoken', 'expires_on')
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'bEsScFxAJJ8jiqovwPhsVCPzHCDe26'", 'max_length': '30'}),
