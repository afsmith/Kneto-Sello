...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('management_oneclicklinktoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('token', self.gf('django.db.models.fields.CharField')(default='p2acK', max_length=30)),
        ))
        db.send_create_signal('management', ['OneClickLinkToken'])


    def backwards(self, orm):
        
        # Deleting model 'OneClickLinkToken'
        db.delete_table('management_oneclicklinktoken')
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'SIc9g'", 'max_length': '30'}),
