...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('management_userprofile', 'language', self.gf('django.db.models.fields.CharField')(max_length=7))
        for profile in orm['management.UserProfile'].objects.all():
            profile.language = ''
            profile.save()
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.language'
        db.alter_column('management_userprofile', 'language', self.gf('django.db.models.fields.IntegerField')())
        for profile in orm['management.UserProfile'].objects.all():
            profile.language = 0
            profile.save()
