...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('management_oneclicklinktoken', 'allow_login', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OneClickLinkToken.allow_login'
        db.delete_column('management_oneclicklinktoken', 'allow_login')
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'MnOCQGImISEVNzShW2uCnrWtHRDmof'", 'max_length': '30'}),
