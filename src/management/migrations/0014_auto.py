...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'UserProfile', fields ['role']
        db.create_index('management_userprofile', ['role'])


    def backwards(self, orm):
        
        # Removing index on 'UserProfile', fields ['role']
        db.delete_index('management_userprofile', ['role'])
    ...
    models = {
        ...
        'management.oneclicklinktoken': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'08oc3sz5Iz1EzVqHOLeAtXpv2wNZF0'", 'max_length': '30'}),
