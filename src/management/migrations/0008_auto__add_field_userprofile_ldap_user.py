...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.ldap_user'
        db.add_column('management_userprofile', 'ldap_user', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.ldap_user'
        db.delete_column('management_userprofile', 'ldap_user')
