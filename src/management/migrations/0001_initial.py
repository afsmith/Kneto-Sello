...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('management_userprofile', (
        ...
        db.send_create_signal('management', ['UserProfile'])
        db.really_send_create_signal('management', ['UserProfile'])


    def backwards(self, orm):
        
        # Deleting model 'UserProfile'
        db.delete_table('management_userprofile')
