...
import calendar, json, os, urllib, urlparse, StringIO
...
import utils, course_states, type_specifiers
...
class CourseGroup(models.Model):
    ...
    group = models.ForeignKey(auth_models.Group)
    course = models.ForeignKey(Course)
    assigner = models.ForeignKey(auth_models.User, null=True)
...
class CollectionElem(models.Model):
