...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('content_file_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('file', models.ForeignKey(orm['content.file'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('content_file_groups', ['file_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('content_file_groups')

        # Changing field 'File.language'
        db.alter_column('content_file', 'language', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'ZJy3eWJ62J9yLxVM1Vr8h4'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'j8J4w'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'5Q4B5'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
