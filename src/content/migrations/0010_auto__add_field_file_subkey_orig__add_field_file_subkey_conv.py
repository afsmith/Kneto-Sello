...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'File.subkey_orig'
        db.add_column('content_file', 'subkey_orig', self.gf('django.db.models.fields.CharField')(default='dYeUa', max_length=5), keep_default=False)

        # Adding field 'File.subkey_conv'
        db.add_column('content_file', 'subkey_conv', self.gf('django.db.models.fields.CharField')(default='RSHhv', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'File.subkey_orig'
        db.delete_column('content_file', 'subkey_orig')

        # Deleting field 'File.subkey_conv'
        db.delete_column('content_file', 'subkey_conv')
    ...
    models = {
        ...
        'content.file': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'V97pFrXkWVp6YIHL8wiWJC'", 'unique': 'True', 'max_length': '22'}),
            'orig_filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'h8qtf'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'wlXh8'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
