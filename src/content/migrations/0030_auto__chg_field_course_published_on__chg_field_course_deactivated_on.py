...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.published_on'
        db.alter_column('content_course', 'published_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Course.deactivated_on'
        db.alter_column('content_course', 'deactivated_on', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Course.published_on'
        db.alter_column('content_course', 'published_on', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Course.deactivated_on'
        db.alter_column('content_course', 'deactivated_on', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'VVwVLkNCEy2aZP1vcfPBIs'", 'unique': 'True', 'max_length': '22'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'rokCi'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'Y6XVg'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'ziAK6'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
