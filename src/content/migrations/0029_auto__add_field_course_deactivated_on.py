...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.deactivated_on'
        db.add_column('content_course', 'deactivated_on', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.deactivated_on'
        db.delete_column('content_course', 'deactivated_on')
    ...
    models = {
        ...
        'content.course': {
            ...
            'deactivated_on': ('django.db.models.fields.DateField', [], {'null': 'True'}),
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'LbPOarQUSFGHnlMxVR6xpl'", 'unique': 'True', 'max_length': '22'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'eFqSg'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'qKsiD'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'6HX5o'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
