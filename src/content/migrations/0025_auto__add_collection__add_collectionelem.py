...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CollectionElem'
        db.create_table('content_collectionelem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.File'])),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Collection'])),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('content', ['CollectionElem'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CollectionElem'
        db.delete_table('content_collectionelem')
    ...
    models = {
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'MtamUpnBH1Rgk3TkSrsHzv'", 'unique': 'True', 'max_length': '22'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'z4vPC'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'0C63K'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'SOGEC'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
