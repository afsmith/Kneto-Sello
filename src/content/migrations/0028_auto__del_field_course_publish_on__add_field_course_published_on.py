...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Course.publish_on'
        db.delete_column('content_course', 'publish_on')

        # Adding field 'Course.published_on'
        db.add_column('content_course', 'published_on', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Course.publish_on'
        db.add_column('content_course', 'publish_on', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Deleting field 'Course.published_on'
        db.delete_column('content_course', 'published_on')
    ...
    models = {
        ...
        'content.course': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'published_on': ('django.db.models.fields.DateField', [], {'null': 'True'}),
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'jQgf9y1ghvGNVzjryH2BHC'", 'unique': 'True', 'max_length': '22'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'G5dOo'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'TE0sf'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'dNm2A'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
