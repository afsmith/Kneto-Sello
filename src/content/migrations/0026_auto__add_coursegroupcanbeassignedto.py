...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('content_coursegroupcanbeassignedto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Course'])),
        ))
        db.send_create_signal('content', ['CourseGroupCanBeAssignedTo'])


    def backwards(self, orm):
        
        # Deleting model 'CourseGroupCanBeAssignedTo'
        db.delete_table('content_coursegroupcanbeassignedto')
    ...
    models = {
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'x37s2jpB4vygd8D98EoICO'", 'unique': 'True', 'max_length': '22'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'KE5ct'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'QvRus'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'UzHhK'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
