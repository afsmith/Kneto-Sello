...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('content_coursegroup', (
        ...
        db.send_create_signal('content', ['CourseGroup'])


    def backwards(self, orm):
        
        # Deleting model 'CourseGroup'
        db.delete_table('content_coursegroup')
    ...
    models = {
        ...
        'content.file': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'BMWBKy9j6g7Jmc9lhT0jDN'", 'unique': 'True', 'max_length': '22'}),
