...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'File.subkey_thumbnail'
        db.add_column('content_file', 'subkey_thumbnail', self.gf('django.db.models.fields.CharField')(default='HxVH5', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'File.subkey_thumbnail'
        db.delete_column('content_file', 'subkey_thumbnail')
    ...
    models = {
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'Iro6X3Or3w2yzAf0QsJ0a'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'ZrI4i'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'5zxKY'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'dKLFP'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
