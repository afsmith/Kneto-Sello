...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'File.subkey_preview'
        db.add_column('content_file', 'subkey_preview', self.gf('django.db.models.fields.CharField')(default='c7pvu', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'File.subkey_preview'
        db.delete_column('content_file', 'subkey_preview')
    ...
    models = {
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'sfi3BRaHJ5MTOlSwvK6EnM'", 'unique': 'True', 'max_length': '22'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'c3ZPd'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'UCbtH'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'TQn8v'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'LGvEL'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
