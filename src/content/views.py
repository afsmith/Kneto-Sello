...
def create_module(request, id=None):
    ...
    return direct_to_template(request, 'content/module_creator.html', ctx)
...
def edit_content(request, file_id):
    ...
    return direct_to_template(request, 'content/module_content.html',
                               {'is_edited': True,
...
def files_manage(request):
    ...
    return direct_to_template(request, 'content/files_manage.html', ctx)
...
def import_file(request):
    ...
    if request.method == 'GET':
        ...
        return direct_to_template(request, 'content/module_content.html', {'importFileForm': forms.FileImportForm(),
...
def choose_file_from_dms(request):
    if request.method == 'GET':
        return direct_to_template(request, 'content/dialogs/choose_file_from_dms.html')
    else:
...
def file_source(request, id):
    ...
    return direct_to_template(request, 'content/file_source.html', ctx)
...
def rss_feeds_list(request):
    return direct_to_template(request, 'content/rss.html', {
