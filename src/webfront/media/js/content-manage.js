...
$(document).ready(function(){
    ...
    $('#mcd').live('click', function(){
        ...
        if(fileId){
            ...
            var duration = $("#id_duration").val().trim();
    ...
    function sendContent( oldTags, newTags) {
        ...
        $.post("/content/manage/save/", JSON.stringify({
            ...
            "duration": $("#id_duration").val().trim(),
            "is_downloadable": $("#id_is_downloadable").attr("checked"),
            "delete_after_expire": $("#id_delete_expired").attr("checked"),
            "note": $("#id_note").val()
        }), function(data){
            if(data.status == "OK") {
                                ...
                                events: [
                                    {
                                        name: 'click',
                                        handler: function(e) {
                                            app.helpers.cookie.set('dont_show_popup_next_time', $('#dont_show_popup_next_time').attr("checked"));
    ...
    $('#tagList').children('li').each(function(){
       app.data.tags.push({id: $(this).attr('id').replace('tag_', ''), name: $(this).text().trim()});
    });
