...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScormActivityDetails'
        db.create_table('tracking_scormactivitydetails', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('segment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Segment'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('tracking', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracking.TrackingEvent'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('result', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('tracking', ['ScormActivityDetails'])


    def backwards(self, orm):
        
        # Deleting model 'ScormActivityDetails'
        db.delete_table('tracking_scormactivitydetails')
    ...
    models = {
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'m5cAfeh3cv1L20WmMtqU18'", 'unique': 'True', 'max_length': '22'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'DJTSZ'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'Ml2GR'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'eKUnD'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
