...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tracking_trackingevent', 'client_ip', self.gf('django.db.models.fields.CharField')(max_length=41, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TrackingEvent.client_ip'
        db.delete_column('tracking_trackingevent', 'client_ip')
    ...
    models = {
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'Lu4DwLqadT4oNLHuKaiAtR'", 'unique': 'True', 'max_length': '22'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'EItlD'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'jZqxz'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'dkvRN'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'1Ih0L'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
        ...
        'tracking.trackingevent': {
            ...
            'client_ip': ('django.db.models.fields.CharField', [], {'max_length': '41', 'null': 'True'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
