...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrackingEvent.parent_event'
        db.add_column('tracking_trackingevent', 'parent_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracking.TrackingEvent'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TrackingEvent.parent_event'
        db.delete_column('tracking_trackingevent', 'parent_event_id')
    ...
    models = {
        ...
        'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'xnDWeqnEpxLNueCRlWOvUR'", 'unique': 'True', 'max_length': '22'}),
            'language': ('django.db.models.fields.CharField', [], {'max_length': '7'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'m12Db'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'Y9wRd'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'uWYPh'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
